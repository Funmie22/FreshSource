-- FreshSource production PostgreSQL schema for Supabase.
-- Apply in Supabase SQL Editor for a new project.
...
-- Authenticated users manage only their own profile/listings/orders.
...
-- Server-side FastAPI uses its PostgreSQL connection role for webhook writes.
