  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[var(--color-background-warm)]">
      <header className="relative z-20 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-12">
        ...
        <div className="flex items-center gap-3"><a href={whatsappUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2.5 text-xs font-bold text-[#102A2E] transition-transform hover:-translate-y-0.5"><WhatsAppMark /> WhatsApp us</a></div>
      </header>
