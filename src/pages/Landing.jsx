    ...
    <main className="min-h-screen overflow-hidden bg-[var(--color-background-warm)] text-[var(--color-charcoal)]">
      ...
      >
        ...
        >
          <h1 className="font-[var(--font-heading)] text-4xl md:text-6xl text-white leading-tight">
            Lagos's harvest spoils <span className="italic">before it reaches Abuja.</span>
          </h1>
          <p className="mt-4 text-white/90 text-lg mx-auto">
            FreshSource gets them there in under 12 hours — guaranteed pickup, guaranteed price, zero middlemen.
          </p>
      ...
      <AnimatedSection className="bg-[var(--color-surface)] px-6 md:px-10 py-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="mt-4 text-[var(--color-charcoal)]/80 text-sm leading-relaxed">
              Join a network of vetted carriers with access to high-demand routes from Lagos State to urban hubs.
            </p>
          </motion.div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection className="bg-[var(--color-surface)] px-6 md:px-10 py-14 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 text-center border-t border-b border-black/5">
        ...
        <div>
          ...
          <p className="text-xs text-[var(--color-charcoal)]/70 mt-1">
            Verified smallholder farmers in the Lagos Hub ecosystem
          </p>
        </div>
        <div>
      ...
      <AnimatedSection className="bg-[var(--color-primary-dark)] text-white px-6 md:px-10 py-16 text-center">
        <motion.div variants={fadeUp} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-4 text-white/80 max-w-xl mx-auto text-sm leading-relaxed">
            Farmers without internet access can list produce and check orders via USSD — just like dialing *123#. Try the live simulator below.
          </p>
          <motion.div whileTap={{ scale: 0.96 }} className="inline-block mt-8">
            <Link
              to="/ussd"
