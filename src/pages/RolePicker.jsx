  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FAFAF8] to-[#F5F3F0] flex items-center justify-center px-6 py-12">
      ...
      >
        <button
          onClick={() => navigate('/')}
          className="mb-4 text-sm font-semibold text-gray-600 hover:text-[var(--color-primary)] transition-colors text-left"
        >
          ← Back
        </button>
        <h1 className="text-4xl font-bold text-[var(--color-primary-dark)] mb-3">FreshSource</h1>
        ...
        <div className="space-y-3">
          {ROLES.map((role, i) => (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full p-6 border-2 border-gray-300 rounded-lg hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)]/5 transition-all text-left bg-white disabled:opacity-60"
            >
